 ...
 * Libraries:
 *  - jQuery (>= v1.6.2)
 *      as requirejs module "jquery"
 *  - jQuery Mobile (jQuery plugin, 1.4.5); $.mobile
 *  	as requirejs module "jqm"
 *  - SimpleModal (jQuery plugin, >= v1.4.4); $.modal
 *      as requirejs module "jqmSimpleModal"
 *
 ...
 *  @see mmir.viewEngine
 */
function(consts, jquery, loadCss, module, require){

	var basePath = consts.getBasePath()
	var cssPath = module.config().cssUrl;
	//load CSS for jQuery Mobile:
	loadCss(basePath+cssPath);
